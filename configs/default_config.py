...
cfg.checkpoint.mode = (
    "auto"  # Automatically determine direction of improvement (increase or decrease)
)
...
cfg.model.loss.progressive_scaling = (
    0.0  # Training percentage to decay number of scales
)
